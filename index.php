...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="img/onilineImg.png">
                    ...
                    <nav class="custom_tabs text-center">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                                role="tab" aria-controls="nav-home" aria-selected="true">BTech </a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                role="tab" aria-controls="nav-profile" aria-selected="false">BBA </a>
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                                role="tab" aria-controls="nav-contact" aria-selected="false">BCA</a>
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="img/datastrcimg.png" alt="">
                                </div>
                                <div class="program__content">
                                    ...
                                    <a href="#" class="boxed-btn5">Enter now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="img/operatimg.JPEG" alt="">
                                </div>
                                <div class="program__content">
                                    <span></span>
                                    <h4></h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="img/algoritmimg.JPEG" alt="">
                                </div>
                                <div class="program__content">
                                    <span></span>
                                    <h4></h4>
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        <div class="thumb">
                            ...
                            <span class="badge bandge_2"></span>
                        </div>
                        <div class="news_info">
                            <a href="single-blog.html">
                                <h4></h4>
