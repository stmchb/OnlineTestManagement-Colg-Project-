...
<head>
    ...
    <link rel="shortcut icon"  href="img/onlinetestimg.png">
                    ...
                    <div class="col-lg-7">
                        <div class="admission_form">
                            ...
                            if (isset($_POST['login'])) {
                                $data = mysqli_query($conn, "select type from tbl_signup where email='" . $_POST['email'] . "'and password='" . $_POST['password'] . "'");
                                if ($dt = mysqli_fetch_array($data)) {
                                    if ($dt['type'] == "user") {
                                        $_SESSION['user'] = $_POST['email'];
                                        echo "<script>window.location='user/userHome1.php'</script>";
                                    } elseif ($dt['type'] == "admin") {
                                        $_SESSION['admin'] = $_POST['email'];
                                        echo "<script>window.location='admin/addSubject.php'</script>";
                                    }
                                } else {
                                    echo "<span style='color:red'>Please Check Your Email and Password!</span>";
                                }
                            }
                            ?>
                        </div>
